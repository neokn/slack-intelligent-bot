...
- Node.js v22.18+
- one of package manager: `pnpm` **(Recommand)**, `npm`, `yarn`
...
Get Slack Releated token from [Slack API App](https://api.slack.com/apps)

- SLACK_BOT_TOKEN - Your Slack bot token (starts with `xoxb-`)
- SLACK_APP_TOKEN - Your Slack bot token (starts with `xapp-`)
